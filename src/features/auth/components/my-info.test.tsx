...
import useGetMyInfo from "@features/auth/hooks/use-get-my-info.ts";
import MyInfo from "@features/auth/components/my-info.tsx";
import { MyInfoResponse } from "@features/auth/types.ts";
import { getMyInfo } from "@features/auth/apis.ts";
...
jest.mock("@features/auth/apis.ts");
